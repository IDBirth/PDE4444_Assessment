#!/usr/bin/env python3
# Example usage:
# python /home/ubu/Desktop/Assessment/defect_classification_stack/demo_live_test_with_video.py \
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Demo runner that always shows annotated video unless --no-show is passed."
    )
    ...
    parser.add_argument(
        ...
        dest="show",
        action="store_false",
        help="Run without opening the annotated video window.",
    )
...
def main() -> None:
    ...
    paused = False
    window_name = "demo-live-test-with-video"
